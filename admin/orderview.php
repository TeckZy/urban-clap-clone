...
$final_q1="<div class='form-group mb25'>
	<h4>$mainhead<h4>
		<h5>$subhead</h5>";
if(!empty($qusans1['ans1'] && $qusans1['qus1'])) $q1=$final_q1."<br>"."<p>".$qusans1['ans1']."</p></div>"; 
elseif(!empty($qusans1['ans2'] && $qusans1['qus1'])) $q1=$final_q1."<br>"."<p>".$qusans1['ans2']."</p></div>"; 
elseif(!empty($qusans1['ans3'] && $qusans1['qus1'])) $q1=$final_q1."<br>"."<p>".$qusans1['ans3']."</p></div>";
elseif(!empty($qusans1['ans4'] && $qusans1['qus1'])) $q1=$final_q1."<br>"."<p>".$qusans1['ans4']."</p></div>"; 
elseif(!empty($qusans1['ans5'] && $qusans1['qus1'])) $q1=$final_q1."<br>"."<p>".$qusans1['ans5']."</p></div>"; else $q1="";
...
$final_q2="<div class='form-group mb25'>
	<h4>$mainhead<h4>
		<h5>$subhead</h5>";
if(!empty(implode(',',$qusans2['ans1']) && $qusans2['qus1'])) $q2=$final_q2."<br>"."<p>".implode(',',$qusans2['ans1'])."</p></div>"; 
elseif(!empty(implode(',',$qusans2['ans2']) && $qusans2['qus1'])) $q2=$final_q2."<br>"."<p>".implode(',',$qusans2['ans2'])."</p></div>"; 
elseif(!empty(implode(',',$qusans2['ans3']) && $qusans2['qus1'])) $q2=$final_q2."<br>"."<p>".implode(',',$qusans2['ans3'])."</p></div>";
elseif(!empty(implode(',',$qusans2['ans4']) && $qusans2['qus1'])) $q2=$final_q2."<br>"."<p>".implode(',',$qusans2['ans4'])."</p></div>"; 
elseif(!empty(implode(',',$qusans2['ans5']) && $qusans2['qus1'])) $q2=$final_q2."<br>"."<p>".implode(',',$qusans2['ans5'])."</p></div>"; else $q2="";
...
$final_q3="<div class='form-group mb25'>
	<h4>$mainhead<h4>
		<h5>$subhead</h5>";
if(!empty($qusans3['ans1'] && $qusans3['qus1'])) $q3=$final_q3."<br>"."<p>".$qusans3['ans1']."</p></div>"; 
elseif(!empty($qusans3['ans2'] && $qusans3['qus1'])) $q3=$final_q3."<br>"."<p>".$qusans3['ans2']."</p></div>"; 
elseif(!empty($qusans3['ans3'] && $qusans3['qus1'])) $q3=$final_q3."<br>"."<p>".$qusans3['ans3']."</p></div>";
elseif(!empty($qusans3['ans4'] && $qusans3['qus1'])) $q3=$final_q3."<br>"."<p>".$qusans3['ans4']."</p></div>"; 
elseif(!empty($qusans3['ans5'] && $qusans3['qus1'])) $q3=$final_q3."<br>"."<p>".$qusans3['ans5']."</p></div>"; else $q3="";
...
$final_q4="<div class='form-group mb25'>
	<h4>$mainhead<h4>
		<h5>$subhead</h5>";
if(!empty($qusans4['ans1'] && $qusans4['qus1'])) $q4=$final_q4."<br>"."<p>".$qusans4['ans1']."</p></div>"; 
elseif(!empty($qusans4['ans2'] && $qusans4['qus1'])) $q4=$final_q4."<br>"."<p>".$qusans4['ans2']."</p></div>"; 
elseif(!empty($qusans4['ans3'] && $qusans4['qus1'])) $q4=$final_q4."<br>"."<p>".$qusans4['ans3']."</p></div>";
elseif(!empty($qusans4['ans4'] && $qusans4['qus1'])) $q4=$final_q4."<br>"."<p>".$qusans4['ans4']."</p></div>"; 
elseif(!empty($qusans4['ans5'] && $qusans4['qus1'])) $q4=$final_q4."<br>"."<p>".$qusans4['ans5']."</p></div>"; else $q4="";
...
$final_q5="<div class='form-group mb25'>
	<h4>$mainhead<h4>
		<h5>$subhead</h5>";
if(!empty($qusans5['ans1'] && $qusans5['qus1'])) $q5=$final_q5."<br>"."<p>".$qusans5['ans1']."</p></div>"; 
elseif(!empty($qusans5['ans2'] && $qusans5['qus1'])) $q5=$final_q5."<br>"."<p>".$qusans5['ans2']."</p></div>"; 
elseif(!empty($qusans5['ans3'] && $qusans5['qus1'])) $q5=$final_q5."<br>"."<p>".$qusans5['ans3']."</p></div>";
elseif(!empty($qusans5['ans4'] && $qusans5['qus1'])) $q5=$final_q5."<br>"."<p>".$qusans5['ans4']."</p></div>"; 
elseif(!empty($qusans5['ans5'] && $qusans5['qus1'])) $q5=$final_q5."<br>"."<p>".$qusans5['ans5']."</p></div>"; else $q5="";
