...
$GetRecords=$db->get_all("select * from review where professionalid='$id'");
...
foreach($GetRecords as $i=>$GetRecord) {
    ...
    $disp .="<tr>
				...
				<a  href='review.php?id=$id&review=$idvalue&act=del' title='Delete' onclick='return makesure()' type='button' class='btn btn-sm btn-icon btn-secondary btn-danger' title='Delete'><i class='fa fa-trash-o'></i></a>	
				</div>
				</td>
			</tr>";
			$sno++;
