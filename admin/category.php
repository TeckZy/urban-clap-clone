...
$GetRecord=$db->get_all("select * from category where parent_id='0' order by category_name asc");
...
for($i = 0 ; $i < count($GetRecord) ; $i++) {
    ...
    $disp .="<tr>
				<td>$slno</td>
				<td  align='left'><a href='subcategory.php?id=$idvalue'>$GT_RightSign $category_name</a></td>
				<td  align='left'> <img src='$siteurl/admin/uploads/category/".$img."' width='100px' class='img-circle'/></td>
				<td width='20%'>
