...
function get_Rate($id){
 ...
 $ratecount = $db->Extract_Single("select count(stars) from review where professionalid='$id' and active_status='1'");  
 if($ratecount!=0){
