...
if($submit) {
	...
	if($checkStatus == 0){
		...
		if($img!=''){
			$file_to=uniqid();
			$file=$com_obj->upload_image("img",$file_to,500,500,"uploads/category/","NULL");
			if($file){
	    ...
	    <div class="col-xs-12">
	        <div class="card">
	            <div class="card-header">
	                <h4 class="card-title"><?php echo $TextChange;?> Category</h4>
	            ...
	            <div class="card-body collapse in">
	                ...
	                <form class="form-horizontal" method="post" action="categoryupd.php" enctype="multipart/form-data">
					 ...
					 <p style="font-size:14px;"> **Only jpg, jpeg, png, gif, bmp file with dimension above 500X500 & maximum size of 1 MB is allowed. </p>
