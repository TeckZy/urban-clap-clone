      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="welcome.php" class="navbar-brand"><img alt="stack admin logo" src="<?="$siteurl/admin/uploads/general_setting/$sitelogo";?>" class="brand-logo" style="max-width:100%;margin-top:-10px;">
                </a></li>
        ...
        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            ...
            <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="uploads/userimages/<?echo $user_images;?>" alt="avatar"><i></i></span><span class="user-name">Admin</span></a>
            <div class="dropdown-menu dropdown-menu-right">
			<a href="general_settingupd.php" class="dropdown-item"><i class="icon-settings"></i> Setting</a> 
			<a href="user-profile.php" class="dropdown-item"><i class="icon-users"></i> User List</a>
			<a href="company-profile.php" class="dropdown-item"><i class="icon-badge"></i> <?=$keyword;?> List</a>
			<a href="reviews_all.php" class="dropdown-item"><i class="icon-speech"></i> Reviews</a>
