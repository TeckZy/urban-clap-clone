...
{
	$id=$_REQUEST['inact'];
	$act=$db->insertrec("update banner set ban_status='0' where ban_id='$id'");
	if($act)
	{
...
{
	$id=$_REQUEST['act'];
	$act=$db->insertrec("update banner set ban_status='1' where ban_id='$id'");
	if($act)
	{
...
if(isset($_REQUEST['delete']))
{
	...
	$did=$_REQUEST['delete'];
	$det=$db->insertrec("delete from banner where ban_id='".$did."'");
