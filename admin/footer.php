 <footer class="footer footer-static footer-light navbar-border">
      <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; <?php echo date("Y"); ?> <a href="#" target="_blank" class="text-bold-800 grey darken-2"><?=$sitetitle;?> </a>, All rights reserved. </span></p>
    </footer>
...
<!--end-->
		<script src="<?=$siteurl;?>/js/bootstrap-timepicker.js"></script>
		<script>
