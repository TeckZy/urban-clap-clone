...
if($home_img == "noimage.jpg") {
    ...
    $ShowOldImg = "";
	$DisplayDeleteImgLink = '<a href="general_settingupd.php?act=del&nimg='.$home_img.'&id='.$id.'">Delete</a>';
}
	        ...
	        <div class="card">
	            ...
	            <div class="card-body collapse in">
					...
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-12"><input name="instra" class="form-control" value="<?echo $instraurl;?>" placeholder="Instagram Link"></div>
					</div>
					...
					<div class="form-group col-sm-12">
						<label class="col-sm-12 control-label">Copy Rights</label>
						<div class="col-sm-12"><input name="copyright" class="form-control" value="<?echo $copyright;?>" placeholder="Copy Rights Info"></div>
					</div>
