...
<?php } ?>
      <div class="wizard" <?php echo $style; ?>>
            <div class="wizard-inner">
				...
				<?php 
					...
					if(!empty($catid) || !empty($searchservice)){
						//echo "select * from question_mgmt where  status='1' $sql or q_type='5'"; exit;
            ...
            <form role="form" method="post">
                <div class="<?php if(!empty($catid) || !empty($searchservice)){ echo "tab-content"; }else{ echo "";}?>">
				<?php 
            ...
            <output id="rangeInfo"><?php echo isset($min)?$min:$value; ?></output>
                           ...
                           <div class="filter_type">
							  ...
							  <?php // echo $com_obj->getRevCount(3); ?>
                                 ...
                                 <li><label><input type="checkbox" name="option_1" <?php if($option_1==5){ ?> checked <?php } ?> id="checkbox_1" value="5" ><span class="rating">
                                 ...
                                 <li><label><input type="checkbox" name="option_2" <?php if($option_2==4){ ?> checked <?php } ?> value="4"><span class="rating">
                                 ...
                                 <li><label><input type="checkbox" name="option_3" <?php if($option_3==3){ ?> checked <?php } ?> value="3"><span class="rating">
                                 ...
                                 <li><label><input type="checkbox" name="option_4" <?php if($option_4==2){ ?> checked <?php } ?> value="2"><span class="rating">
                                 ...
                                 <li><label><input type="checkbox" name="option_5" <?php if($option_5==1){ ?> checked <?php } ?> value="1"><span class="rating">
                           ...
                           <div class="filter_type">
                              ...
                              <ul>
<?php
$homelocation=$db->get_all("select distinct state from register where active_status='1' and user_role='1' and state!='' limit 6");
if(!empty($homelocation)){
	...
	foreach($homelocation as $i=>$locInfo){
		...
		if($state!=""){
			...
			$loc_name = 'loc_'.$i;
?>
                                 <li><label><input type="checkbox" name="<?=$loc_name;?>" value="<?php echo $locInfo['state']; ?>" <?php if($loc_name==($locInfo['state'])){ echo "checked"; ?>  <?php } ?> ><?php echo $state; ?></label></li>
<?php }  } } else{ ?>
...
<?php } ?>
                  ...
                  <div class="col-lg-9 col-md-9">
					...
					$limit=limitation($rowsPerPage);
					 ...
					 if(!empty($loc_1)){
						 if($filter!="") {
							$sql.= $filter." register.state='$loc_1'";
						}
						else {
							$sql.="and register.state='$loc_1'";
							$filter = " or ";
						}
					 }
					if(!empty($loc_2)){
						 if($filter!="") {
							$sql.= $filter." register.state='$loc_2'";
						}
						else {
							$sql.="and register.state='$loc_2'";
							$filter = " or ";
						}
					 }
					 if(!empty($loc_3)){
						 if($filter!="") {
							$sql.= $filter." register.state='$loc_3'";
						}
						else {
							$sql.="and register.state='$loc_3'";
							$filter = " or ";
						}
					 }
					if(!empty($loc_4)){
						 if($filter!="") {
							$sql.= $filter." register.state='$loc_4'";
						}
						else {
							$sql.="and register.state='$loc_4'";
							$filter = " or ";
						}
					 }
					 if(!empty($loc_5)){
						 if($filter!="") {
							$sql.= $filter." register.state='$loc_5'";
						}
						else {
							$sql.="and register.state='$loc_5'";
							$filter = " or ";
						}
					 }
					...
					if(isset($option_1) && ($option_1==5)) {
						$sql.=" and review.stars='5'";
						$filter = "or ";
					 } 
					 
					if(isset($option_2) && ($option_2==4)) {
					 if($filter!="") {
							$sql.= $filter." review.stars='4'";
						}
						else {
					 ...
					 if(isset($option_3) && ($option_3==3)) {
					 if($filter!="") {
							$sql.= $filter." review.stars='3'";
						}
						else {
					 ...
					 if(isset($option_4) && ($option_4==2)) {
					 if($filter!="") {
							$sql.= $filter." review.stars='2'";
						}
						else {
					 ...
					 if(isset($option_5) && ($option_5==1)) {
					 if($filter!="") {
							$sql.= $filter." review.stars='1')";
						}
						else {
					 ...
					 //print_r($_REQUEST);
					 //echo "select * from register LEFT JOIN review on register.id=review.professionalid where register.active_status='1' and register.user_role='1' $sql";
					//echo "select * from register LEFT JOIN review on register.id=review.professionalid where register.user_role='1' $sql";
					 
					 $que="select register.* from register LEFT JOIN review on register.id=review.professionalid where register.active_status='1' and register.user_role='1' $sql";
					 //echo $que;
					 ...
					 if(!empty($getInfo)){
						 foreach($getInfo as $detail){
							...
							$img=$detail['img'];
							if(!empty($fees)){
								$e_fees=$site_currency." ".$fees;
								$e_dur=$duration;
							}else{
								$e_fees=$site_currency." "."0";
								$e_dur="";
							}
							$name=$fname." ".$lname;
							if(!empty($img)){
