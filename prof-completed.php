...
$catid=$catid['cat_id'];
$reqInfo=$db->get_all("select * from sent_enquiry where cat_id='$catid' and status!='6' and prof_response='4' and receiver_id='$psesid' ");
$i=1;
foreach($reqInfo as $req){
	...
	$role=$req['role'];
	if($role==0){
		$ordertype="<div style='color:#ff5e62;'><b>Group Order</b></div>";
	}else{
		$ordertype="<div style='color:#5e6aff;'><b>Individual Order</b></div>";
	}
?>
					        <tr>
							   <td><?php echo $i; ?></td>
							   ...
							   <td>
							     <ul class="edt_list">
									<li><a href="#" class="btn-sm btn-success">Completed</a></li>
