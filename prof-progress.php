...
<?php } ?>					  
		...
		<div class="row mb10">
		   <div class="col-sm-12">
		       <h3 class="clr_txt">My Order and Request List</h3>
		   </div>
			       ...
			       <table id="example" class="table table-striped table-bordered appointments_tbl" cellspacing="0" width="100%">
				      ...
				      <thead>
					       <tr>
						      ...
						      <th>Location</th>
						      <th>Order Type</th>
						      <th style="min-width:130px;">Response</th>
						      <!-- <th>View</th> -->
						   </tr>
					   </thead>
					   <tbody>
...
$catid=$catid['cat_id'];
$reqInfo=$db->get_all("select * from sent_enquiry where cat_id='$catid' and status!='6' and prof_response='3' and receiver_id='$psesid'");
$i=1;
foreach($reqInfo as $req){
	...
	$role=$req['role'];
	if($role==0){
		$order="<div style='color:#ff5e62;'><b>Group Order<b></div>";
	}else if($role==1){
		$order="<div style='color:#5e6aff;'><b>Individual Order</b></div>";
	}
?>
					        <tr>
							   <td><?php echo $i; ?></td>
							   ...
							   <td>
							     <ul class="edt_list">
									<li><a href="#" class="btn-sm btn-info">Inprogress</a></li>
